package ru.mirea.seyfetdinov.r.n.audiorecord;
...
import ru.mirea.seyfetdinov.r.n.audiorecord.databinding.ActivityMainBinding;
...
public class MainActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        recordFilePath = new File(new File(getExternalFilesDir(Environment.DIRECTORY_MUSIC), "/audiorecordtest.3gp").getAbsolutePath());
